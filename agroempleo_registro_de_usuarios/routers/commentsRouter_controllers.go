...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/sena_2824182/Agroempleo_crud/agroempleo_registro_de_usuarios/controllers:IdentificacionController"] = append(beego.GlobalControllerRouter["github.com/sena_2824182/Agroempleo_crud/agroempleo_registro_de_usuarios/controllers:IdentificacionController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
